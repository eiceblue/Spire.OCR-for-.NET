...
Namespace ExportRectangularArea
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			Dim outputFile As String = "ExportRectangularArea_out.txt"
			...
			Using fs As New StreamWriter(outputFile, True)
				For Each blockItem As IOCRTextBlock In scanner.Text.Blocks
					' Get the block text and its rectangular area
					fs.WriteLine("Text£º" & blockItem.Text & vbCrLf & "Rectangular area: " & blockItem.Box.ToString() & vbCrLf)
				Next blockItem
			End Using
