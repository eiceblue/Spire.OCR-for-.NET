...
Namespace ScanImageWithLanguageSelection
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			Dim imageFile As String = "../../../../../Data/JapaneseSample.png"
			Dim outputFile As String = "ScanImageWithLanguageSelection_out.txt"
